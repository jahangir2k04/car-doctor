    ...
    return (
        <div className="carousel w-full h-[600px] rounded-lg">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute h-full p-24 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white w-1/2 space-y-7'>
                        <h2 className='text-6xl font-bold leading-tight'>Affordable <br /> Price For Car Servicing</h2>
